...
extension ExperimentRepetitionResultDto on ExperimentRepetitionResultEntity {
  static ExperimentRepetitionResultEntity fromJson(Map json) {
    return ExperimentRepetitionResultEntity(
      ...
      sample: json['sample'] is double ? json['sample'] : double.parse(json['sample']).toPrecision(5),
      ...
      variableA: json['variableA'] is double ? json['variableA'] : double.parse(json['variableA']).toPrecision(5),
      variableB: json['variableB'] is double ? json['variableB'] : double.parse(json['variableB']).toPrecision(5),
      curve: json['curve'] is double ? json['curve'] : double.parse(json['curve']).toPrecision(5),
      ...
      volume: json['volume'] is double ? json['volume'] : double.parse(json['volume']).toPrecision(5),
      weightSample: json['weightSample'] is double
          ? json['weightSample']
          : double.parse(json['weightSample']).toPrecision(5),
      result: json['result'] is double ? json['result'] : double.parse(json['result']).toPrecision(5),
    );
  }
