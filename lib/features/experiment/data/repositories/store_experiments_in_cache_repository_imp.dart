...
class StoreExperimentsInCacheRepositoryImp implements StoreExperimentsInCacheRepository {
  ...
  Future<void> call(ExperimentPaginationEntity experimentPaginationEntity) async {
    return await _getExperimentsDataSource.saveInCache(experimentPaginationEntity);
  }
}
