...
abstract class IExperimentsController {
  ...
  Future<ExperimentEntity> getExperimentDetailed(String id);
  ...
  Future<void> calculateExperiment(Map<String, dynamic> jsonBody);
