...
class _ExperimentFilterDialogState extends State<ExperimentFilterDialog> {
  ...
  void initState() {
    ...
    dropdownOrderByValue = controller.orderBy;
    dropdownOrderingValue = controller.ordering;
  }
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        ...
        TextButton(
          ...
          onPressed: () {
            controller.setOrderBy(dropdownOrderByValue);
            controller.setOrdering(dropdownOrderingValue);
