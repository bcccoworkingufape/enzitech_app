    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {},
              icon: const Icon(PhosphorIcons.trash, color: AppColors.white, size: 25),
          ),
        ],
      ),
          ...
          child: Column(
            children: [
              ...
              EZTButton(
                ...
                icon: const Icon(PhosphorIcons.pencilLine, color: AppColors.white, size: 30),
                onPressed: () {},
              ),
              const SizedBox(height: 20,),
              EZTButton(
                text: 'Resultados',
                eztButtonType: EZTButtonType.checkout,
                icon: const Icon(PhosphorIcons.fileText, color: AppColors.white, size: 30),
                onPressed: () {},
              ),
            ],
          ),
