...
class _CreateEnzymePageState extends State<CreateEnzymePage> {
  late final CreateEnzymeViewmodel controller;
  ...
  void initState() {
    super.initState();
    controller = context.read<CreateEnzymeViewmodel>();
    ...
    return Column(
      children: [
        EZTButton(
          ...
          loading: controller.state == StateEnum.loading,
          text: 'Criar enzima',
          onPressed: () async {
  ...
  Widget build(BuildContext context) {
    context.watch<CreateEnzymeViewmodel>();
